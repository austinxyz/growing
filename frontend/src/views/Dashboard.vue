<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-8">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600 mt-2">欢迎回来，{{ displayName }}！</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">职业技能</p>
            <h3 class="text-3xl font-bold text-blue-600 mt-2">{{ statistics.totalSkills }}</h3>
            <p class="text-xs text-gray-400 mt-1">Focus Area: {{ statistics.totalFocusAreas }}</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">试题库</p>
            <h3 class="text-3xl font-bold text-green-600 mt-2">{{ statistics.totalQuestions }}</h3>
            <p class="text-xs text-gray-400 mt-1">道题目</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">算法分类</p>
            <h3 class="text-3xl font-bold text-purple-600 mt-2">{{ statistics.algorithmCategories }}</h3>
            <p class="text-xs text-gray-400 mt-1">大分类</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">系统设计基础</p>
            <h3 class="text-3xl font-bold text-orange-600 mt-2">{{ statistics.systemDesignBasics }}</h3>
            <p class="text-xs text-gray-400 mt-1">知识点</p>
          </div>
      ...
      <!-- 系统设计案例 -->
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">系统设计案例</p>
            <h3 class="text-3xl font-bold text-pink-600 mt-2">{{ statistics.systemDesignCases }}</h3>
            <p class="text-xs text-gray-400 mt-1">典型案例</p>
          </div>
      ...
      <!-- 算法模板库 -->
      <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-500 hover:shadow-xl transition-all">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500 font-medium">算法模板库</p>
            <h3 class="text-3xl font-bold text-indigo-600 mt-2">{{ statistics.algorithmTemplates }}</h3>
            <p class="text-xs text-gray-400 mt-1">常用模板</p>
          </div>
