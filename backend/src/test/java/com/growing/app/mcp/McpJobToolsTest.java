...
class McpJobToolsTest {
    ...
    @BeforeEach
    void setContext() {
        McpRequestContext.setUserId(USER_ID);
    }
    ...
    void listApplications_noFilter_callsGetAllAndReturnsTrimmedSummaries() throws Exception {
        ...
        String json = tools.listApplications(null);

        // Service called with current-user id
        ...
        // Output is JSON array of 2; heavy fields are stripped
        @SuppressWarnings("unchecked")
        List<java.util.Map<String, Object>> parsed = objectMapper.readValue(json, List.class);
    ...
    void listApplications_withStatusFilter_callsByStatus() {
        ...
        tools.listApplications("Interviewing");
    ...
    void listApplications_chineseStatusFilter_passesThrough() {
        ...
        tools.listApplications("面试中");

        // Service receives the value verbatim; normalization happens downstream
    ...
    void getApplicationDetail_owned_returnsFullDtoIncludingHeavyFields() throws Exception {
        ...
        String json = tools.getApplicationDetail(42L);
    ...
    void getApplicationDetail_notFound_returns404Error() throws Exception {
        ...
        String json = tools.getApplicationDetail(999L);
    ...
    void getActiveProgress_default_callsActiveOnly() throws Exception {
        ...
        String json = tools.getActiveProgress(false);
    ...
    void getActiveProgress_includeClosed_concatsBoth() throws Exception {
        ...
        String json = tools.getActiveProgress(true);
